...
#define DRIVER_VERSION "v1.0.26_SONiX_"

#if LINUX_VERSION_CODE == KERNEL_VERSION(3,0,36)
#define DRIVER_KERNEL_VERSION		"v3.0.36"
#elif LINUX_VERSION_CODE == KERNEL_VERSION(3,0,35)
#define DRIVER_KERNEL_VERSION		"v3.0.35"
#elif LINUX_VERSION_CODE == KERNEL_VERSION(3,0,8)
#define DRIVER_KERNEL_VERSION		"v3.0.8"
#elif LINUX_VERSION_CODE >= KERNEL_VERSION (2,6,32)
#define DRIVER_KERNEL_VERSION		"v2.6.36.04"
#elif LINUX_VERSION_CODE == KERNEL_VERSION (2,6,30)
#define DRIVER_KERNEL_VERSION		"v2.6.30"
#elif LINUX_VERSION_CODE == KERNEL_VERSION (2,6,28)
#define DRIVER_KERNEL_VERSION		"v2.6.28"
#else
#define DRIVER_KERNEL_VERSION		"v2.6.21.03"
#endif
...
unsigned int DbgPrint_param = 0x3f;
	...
	__u32 **intervals, unsigned char *buffer, int buflen)
{
	...
	if (buflen > 2 && buffer[1] == USB_DT_CS_INTERFACE &&
		...
		for(i = 0; i <n; i++)
		{
			...
			uvc_trace(UVC_TRACE_DESCR, "- still %ux%u\n", format->still_frame[i].wWidth, 
					format->still_frame[i].wHeight);
		}
		buflen -= buffer[0];
		buffer += buffer[0];
	}
		     ...
		     const struct usb_device_id *id)
{
	...
	dev->SONiX_Chip = dev->valid_device = dev->is_fw_correct = 0;
...
#if SONIX_FW_CHECK
		if(dev->SONiX_Chip >=0 && uvc_xu_ctrl_CheckFw(dev)>0)
		{
			dev->is_fw_correct = 1;
		}
#endif
